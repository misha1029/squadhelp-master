...
export const getActiveContests = ({offset, limit, addedContestTypes, contestId, industry, awardSort, ownEntries}) => {
    return http.post('getAllContests', {offset, limit, addedContestTypes, contestId, industry, awardSort, ownEntries})
};
